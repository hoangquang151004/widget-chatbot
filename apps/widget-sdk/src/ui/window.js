    ...
    win.innerHTML = `
      ...
      <div class="w-header">
        ...
        <div class="w-header-info">
          ...
          <div class="w-bot-status"><span class="w-dot"></span>Trực tuyến</div>
        </div>
        <button class="w-close-btn" aria-label="Đóng">${CLOSE_ICON}</button>
      </div>
      ...
      <!-- Footer -->
      ${this._config.showLogo ? `<div class="w-footer">Powered by <a href="https://stitch.com" target="_blank">STITCH</a></div>` : ''}
    `;
